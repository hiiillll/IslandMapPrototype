		...
		public void CameraUpdate() {
			...
			if (copyCam != null && cam != null){
				...
				if (renderTexDiff != null){
					...
					if (cameraType == suiCamToolType.localReflection){
						if (surfaceRenderer != null && surfaceRenderer.sharedMaterial != null) surfaceRenderer.sharedMaterial.SetTexture("_ReflectionTex",renderTexDiff);
					}
					if (cameraType == suiCamToolType.shorelineObject){
						if (surfaceRenderer != null && surfaceRenderer.sharedMaterial != null) surfaceRenderer.sharedMaterial.SetTexture("_MainTex",renderTexDiff);
					}
					if (cameraType == suiCamToolType.shorelineCapture){
