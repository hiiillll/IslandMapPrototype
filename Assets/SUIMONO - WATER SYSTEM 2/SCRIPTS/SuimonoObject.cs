...
namespace Suimono.Core
{
	...
	public class SuimonoObject : MonoBehaviour {
		...
		private Material tempScaleMaterial;
		...
		void Start(){
			...
			if (scaleRenderer != null && suimonoModuleLibrary.materialSurfaceScale != null){
				tempScaleMaterial = new Material(suimonoModuleLibrary.materialSurfaceScale);
				tempScaleMaterial.shader = shader_Scale;
				scaleRenderer.sharedMaterial = tempScaleMaterial;
			}
			...
			if (moduleObject != null){
				...
				if (surfaceRenderer != null){
					...
					*/
					...
					if (scaleRenderer != null && surfaceRenderer != null && typeIndex == 0){
